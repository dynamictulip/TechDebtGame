...
namespace TechDebtGame.Pages
{
    ...
    {
        public List<TechDebtCard> OutstandingTechDebt;
        ...
        public Stack<TechDebtCard> IterationCards { get; private set; }

        public void InitialiseTechDebt()
        {
            OutstandingTechDebt = new List<TechDebtCard>(new[]
                {
                    new TechDebtCard {Cost = 15, Impact = -10, Scenario = "Automate Acceptance Tests"},
                    new TechDebtCard {Cost = 5, Impact = -5, Scenario = "Refactor core code"},
                    new TechDebtCard {Cost = 5, Impact = -5, Scenario = "Setup continuous integration environment"},
                    new TechDebtCard {Cost = 15, Impact = -10, Scenario = "Automate Unit Tests"},
                    new TechDebtCard {Cost = 10, Impact = -5, Scenario = "Automate deployment"}
                }
            );
        }
        ...
        {
            IterationCards = new Stack<TechDebtCard>(new[]
            {
                new TechDebtCard
                {
                    Cost = 0, Impact = 0,
